...
describe('ColorPicker', () => {
	...
	describe('props & attributes', () => {
		...
		test('id attributes are set correctly', async () => {
			...
			const colorHslHueLabel = wrapper.find(`#${id}-color-hsl-h`)
			expect(colorHslHueLabel.exists()).toBe(true)
			const colorHslHueInput = wrapper.find(`#${id}-color-value-hsl-h`)
			expect(colorHslHueInput.exists()).toBe(true)
			const colorHslSaturationLabel = wrapper.find(`#${id}-color-hsl-s`)
			expect(colorHslSaturationLabel.exists()).toBe(true)
			const colorHslSaturationInput = wrapper.find(`#${id}-color-value-hsl-s`)
			expect(colorHslSaturationInput.exists()).toBe(true)
			const colorHslLightnessLabel = wrapper.find(`#${id}-color-hsl-l`)
			expect(colorHslLightnessLabel.exists()).toBe(true)
			const colorHslLightnessInput = wrapper.find(`#${id}-color-value-hsl-l`)
			expect(colorHslLightnessInput.exists()).toBe(true)
			const colorHslAlphaLabel = wrapper.find(`#${id}-color-hsl-a`)
			expect(colorHslAlphaLabel.exists()).toBe(true)
			const colorHslAlphaInput = wrapper.find(`#${id}-color-value-hsl-a`)
			expect(colorHslAlphaInput.exists()).toBe(true)

			await formatSwitchButton.trigger('click')

			const colorHwbRedLabel = wrapper.find(`#${id}-color-hwb-h`)
			expect(colorHwbRedLabel.exists()).toBe(true)
			const colorHwbRedInput = wrapper.find(`#${id}-color-value-hwb-h`)
			expect(colorHwbRedInput.exists()).toBe(true)
			const colorHwbGreenLabel = wrapper.find(`#${id}-color-hwb-w`)
			expect(colorHwbGreenLabel.exists()).toBe(true)
			const colorHwbGreenInput = wrapper.find(`#${id}-color-value-hwb-w`)
			expect(colorHwbGreenInput.exists()).toBe(true)
			const colorHwbBlueLabel = wrapper.find(`#${id}-color-hwb-b`)
			expect(colorHwbBlueLabel.exists()).toBe(true)
			const colorHwbBlueInput = wrapper.find(`#${id}-color-value-hwb-b`)
			expect(colorHwbBlueInput.exists()).toBe(true)
			const colorHwbAlphaLabel = wrapper.find(`#${id}-color-hwb-a`)
			expect(colorHwbAlphaLabel.exists()).toBe(true)
			const colorHwbAlphaInput = wrapper.find(`#${id}-color-value-hwb-a`)
			expect(colorHwbAlphaInput.exists()).toBe(true)

			await formatSwitchButton.trigger('click')

			const colorRgbRedLabel = wrapper.find(`#${id}-color-rgb-r`)
			expect(colorRgbRedLabel.exists()).toBe(true)
			const colorRgbRedInput = wrapper.find(`#${id}-color-value-rgb-r`)
			expect(colorRgbRedInput.exists()).toBe(true)
			const colorRgbGreenLabel = wrapper.find(`#${id}-color-rgb-g`)
			expect(colorRgbGreenLabel.exists()).toBe(true)
			const colorRgbGreenInput = wrapper.find(`#${id}-color-value-rgb-g`)
			expect(colorRgbGreenInput.exists()).toBe(true)
			const colorRgbBlueLabel = wrapper.find(`#${id}-color-rgb-b`)
			expect(colorRgbBlueLabel.exists()).toBe(true)
			const colorRgbBlueInput = wrapper.find(`#${id}-color-value-rgb-b`)
			expect(colorRgbBlueInput.exists()).toBe(true)
			const colorRgbAlphaLabel = wrapper.find(`#${id}-color-rgb-a`)
			expect(colorRgbAlphaLabel.exists()).toBe(true)
			const colorRgbAlphaInput = wrapper.find(`#${id}-color-value-rgb-a`)
