...
/** @typedef {import('../../types/index').VueAccessibleColorPicker.VisibleColorFormat} SupportedColorFormat */

import { formatAsCssColor } from './format-as-css-color.js'

describe('formatAsCssColor', () => {
  test.each(/** @type {[ColorHex, SupportedColorFormat, string][]} */ ([
    ['#fff', 'hex', '#fff'],
    ['#FFF', 'hex', '#FFF'],
    ['#000', 'hex', '#000'],
  ...
  test.each(/** @type {[ColorHsl, SupportedColorFormat, string][]} */ ([
  ...
  test.each(/** @type {[ColorHwb, SupportedColorFormat, string][]} */ ([
  ...
  test.each(/** @type {[ColorRgb, SupportedColorFormat, string][]} */ ([
