...
describe('formatAsCssColor', () => {
  test.each([
    ...
    ['#FFF', 'hex', '#FFF'],
    ['#000', 'hex', '#000'],
  ])('works for HEX colors', (color, /** @type {'hex'} */ format, cssColorString) => {
  ...
  ])('works for HSL colors', (color, /** @type {'hsl'} */ format, cssColorString) => {
    expect(formatAsCssColor(color, format)).toEqual(cssColorString)
  })
  ...
  ])('works for HWB colors', (color, /** @type {'hwb'} */ format, cssColorString) => {
    expect(formatAsCssColor(color, format)).toEqual(cssColorString)
  })
  ...
  ])('works for RGB colors', (color, /** @type {'rgb'} */ format, cssColorString) => {
    expect(formatAsCssColor(color, format)).toEqual(cssColorString)
  })
})
