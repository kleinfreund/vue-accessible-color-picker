...
* add pkg.engines.node ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/d038743))
* fix CSS indentation ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/c255480))
* force space-indentation for .yml files ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/53ff0f6))
* remove unnecessary attachTo uses ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/6602b27))
* replace api-extractor-based build setup with vite-plugin-dts ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/c5852ce))
* simplify commitlint config ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/89dba55))
* switch from pre-commit to pre-push hook ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/f39578d))
* update ESLint config ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/60bcc89))
* use logical properties in CSS ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/fc2d3f5))
* use useTemplateRef ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/0ed478d))
* **deps-dev:** downgrade vite/vue-tsc due to 'Unable to follow symbol for "__VLS_PrettifyGlobal"' error ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/e771139))
* **deps-dev:** regenerate lock file ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/1e3aa3e))
* **deps-dev:** remove conventional-changelog-conventionalcommits override ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/3bca56f))
* **deps-dev:** update all dependencies ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/1ddae79))
* **deps-dev:** update all packages (minor) ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/270350c))
* **deps-dev:** update minor package versions ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/94e7fd2))
* **deps-dev:** update minor package versions ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/17d92ca))
* **deps-dev:** upgrade @stylistic/eslint-plugin to v4 ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/b7eb513))
* **deps-dev:** upgrade @stylistic/eslint-plugin to v5 ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/9e2a303))
* **deps-dev:** upgrade eslint-plugin-vue to v10 ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/9d7eb34))
* **deps-dev:** upgrade vite to v6/vitest to v3 ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/4f5ef25))
* **deps-dev:** upgrade vite/@vitejs/plugin-vue/vue-tsc ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/9b16928))
* **deps:** regenerate lock file ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/a287250))
* **deps:** remove pkg.engines.node ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/6faf122))
* **deps:** remove standard ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/ec1a608))
* **deps:** run npm audit fix ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/a51598c))
* **deps:** run npm dedupe ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/9e8eaac))
* **dist:** update dist files ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/93ac714))
* **dist:** update dist files ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/cd073dc))
* add actions slot ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/80738e0)), closes [#30](https://github.com/kleinfreund/vue-accessible-color-picker/issues/)

  Add optional `actions` slot following the copy button for adding more interactions like a color pipette picker widget.
* expose switchFormat method ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/9b3c60c))
* check build script ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/134d1e8))
* enforce pinned third-party action versions ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/f223026))
* use setup-node caching ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/68a7690))
* add missing color-copy toc entry ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/6a37556))
* clarify vue peer dependency ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/8263b2c))
* update license year ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/1f7195c))
* define inline styles in template ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/78616f3))
* use pointer instead of mouse events ([](https://github.com/kleinfreund/vue-accessible-color-picker/commit/7f86ec5))
